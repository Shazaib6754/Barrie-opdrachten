...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query om de gebruiker te halen uit de database
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            // Toon een foutmelding als de gebruikersnaam of het wachtwoord onjuist is
            echo "Ongeldige gebruikersnaam of wachtwoord.";
        }
    } else {
        // Toon een foutmelding als de ingevoerde gebruikersnaam niet bestaat
        echo "Ongeldige gebruikersnaam of wachtwoord.";
    }
}
